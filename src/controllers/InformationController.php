...
class InformationController extends Controller
{
    ...
    public function displayTable()
    {
        ...
        foreach ($informationList as $information) {
            ...
            $dataList[] = [$row, $this->view->buildCheckbox($name, $information->getId()), $information->getTitle(), $content, $information->getCreationDate(), $information->getExpirationDate(), $information->getAuthor()->getLogin(), $type];
        }
