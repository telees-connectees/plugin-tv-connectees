...
class StudyDirectorView extends UserView
{
    ...
    public function displayTableStudyDirector($users) {
        ...
        return $this->displayTable('Direc', $title, $header, $row, 'director', '<a type="submit" class="btn btn-primary" role="button" aria-disabled="true" href="' . home_url('/creer-utilisateur') . '">Créer</a>');
    }
    ...
    public function displayModifyStudyDirector($user) {
        ...
        <form method="post">
            ...
            <a class="btn btn-danger" href="' . home_url('/gestion-des-utilisateurs/') . '">Annuler</a>
        </form>';
    }
}
