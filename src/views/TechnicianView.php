...
class TechnicianView extends UserView
{
    ...
    public function displayTableTechnicians($users) {
        ...
        return $this->displayTable('Technician', $title, $header, $row, 'Technician', '<a type="submit" class="btn btn-primary" role="button" aria-disabled="true" href="' . home_url('/creer-utilisateur') . '">Créer</a>');
    }
}
