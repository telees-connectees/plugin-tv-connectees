...
class View
{
    ...
    */
    ...
    public function displayTable($name, $title, $dataHeader, $dataList, $idTable = '', $create = '<a type="submit" class="btn btn-primary disabled" role="button" aria-disabled="true">Créer</a>') {
        ...
        if ($title !== '<b>Liste des utilisateurs :</b>' && $title !== '<b>Rôle affiché: </b> Télévision'){
            $table .= '<input type="checkbox" onClick="toggle(this, ' . $name . ')" />';
        }
        $table .= '</th>';
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-auto my-auto">
            ' . $create;
        if ($title !== '<b>Liste des utilisateurs :</b>' && $title !== 'Codes ADE gérés par le système' && $title !== '<b>Rôle affiché: </b> Télévision'){
            $table .= '
